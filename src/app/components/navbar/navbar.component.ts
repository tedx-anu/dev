...
export class NavbarComponent implements OnInit {
    ...
    constructor(location: Location,  private element: ElementRef, private router: Router,private gc : GlobalConstants, private fs: FsService, private af : AngularFireAuth) {
    ...
    getNotifications(){
        this.fs.getNotificationFromOrders()
          .subscribe(data => {
